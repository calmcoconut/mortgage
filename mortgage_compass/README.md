...
│   └── ASGI entry point for asynchronous servers and WebSocket support.
├── [settings.py](file:///Users/alejandrodiaz/Documents/projects/loan/mortgage_compass/settings.py)
│   └── Django settings configuration containing database engine setup (SQLite WAL), installed apps, static asset configuration, humanize helpers, and timezone definitions.
